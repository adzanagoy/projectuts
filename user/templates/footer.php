    ...
    <div class="footer bg-secondary text-light">
        <div class="row px-5 py-3">
            <div class="col-sm ">
                ...
                <p class="foot-item ml-3">
                    <a href="<?= url ?>user/produk.php/?kategori=ponsel">AC</a><br>
                    <a href="<?= url ?>user/produk.php/?kategori=laptop">Meja</a><br>
                </p>
            </div>
            <div class="col-sm ">
                <h6>Halaman</h6>
                <p class="foot-item ml-3">
                    ...
                    <a href="<?= url ?>user/produk.php">Produk</a><br>
                </p>
            </div>
            <div class="col-sm ">
                <h6>Otentikasi</h6>
        ...
        <div class="row justify-content-center">
            <div class="text-center border-top w-100 py-3 bg-secondary">
                <span class="text-light ">&copy Copyright Adzan Yogaswara 0110122117</span>
            </div>
        </div>
    </div>
</footer>
